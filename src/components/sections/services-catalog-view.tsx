...
export function ServicesCatalogView({}: ServicesCatalogViewProps = {}) {
  ...
  return (
    <section className="sticky top-0 z-10 w-full min-h-screen bg-white text-noir-950 flex flex-col justify-center items-center select-none pt-10 sm:pt-16 md:pt-20 pb-16 sm:pb-24 overflow-hidden border-b border-noir-950/[0.08]">
      <div className="w-full max-w-[1520px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 flex flex-col justify-center">
        ...
        >
          <h2 className="font-editorial font-semibold text-4xl sm:text-6xl md:text-7xl lg:text-[5.2rem] text-noir-950 tracking-[-0.035em] uppercase flex items-center justify-center flex-wrap gap-x-2 sm:gap-x-5 md:gap-x-6 leading-none">
            <span>OUR</span>
            {/* Center Animated Bracket Widget */}
            <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-4 py-0.5 sm:py-1.5 border border-noir-900 rounded-md text-xs sm:text-sm md:text-base font-editorial font-bold tracking-widest uppercase my-1">
