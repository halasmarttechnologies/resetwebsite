          ...
          <div className="mb-3 sm:mb-4 max-w-md pointer-events-auto overflow-hidden flex flex-col items-start">
            ...
            >
              <a
                ...
                className="font-jakarta group inline-flex items-center text-white text-base sm:text-lg md:text-xl font-bold underline underline-offset-4 decoration-white hover:text-white/85 transition-all duration-300 mb-1"
              >
            ...
            <motion.p
              ...
              className="font-jakarta text-white text-xs sm:text-sm md:text-base font-medium tracking-wide leading-snug"
            >
              Your glow begins here. Welcome to Reset.
            </motion.p>
          </div>

          {/* Monumental Typography: MEN'S SALON (Balanced Grand Scale, Pure Crisp White) */}
          <div className="w-full overflow-hidden pt-1">
            <h1 className="inline-flex items-center flex-nowrap whitespace-nowrap gap-x-3 sm:gap-x-5 md:gap-x-7 lg:gap-x-10 font-editorial font-black tracking-[-0.045em] text-white text-[clamp(3.0rem,9.6vw,11.2rem)] leading-[0.88] uppercase">
              {/* Word 1: MEN'S */}
