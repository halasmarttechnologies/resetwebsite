            ...
            <div className="flex flex-col gap-5 sm:gap-6">
              ...
              >
                <Image
                  ...
                  alt="Reset Sanctuary Facial Care and Cryo Therapy"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover object-center transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105"
                />
            ...
            <div className="flex flex-col gap-5 sm:gap-6">
              ...
              >
                <Image
                  ...
                  alt="Reset Artisanal Botanicals and Scalp Serum Infusion"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover object-center transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105"
                />
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 flex items-end justify-between z-10">
                  ...
                  <span className="font-jakarta text-xs text-neutral-300 font-normal">
                    Scalp Serum Infusion
                  </span>
                </div>
              </motion.div>

              {/* Card 4: Acupressure Tension Release Massage */}
              <motion.div
                variants={itemVariants}
                initial="hidden"
                whileInView="visible"
              ...
              >
                <Image
                  ...
                  alt="Reset Therapeutic Acupressure and Tension Recovery"
                  fill
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  className="object-cover object-center transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105"
                />
