  ...
  return (
    <section className="relative w-full min-h-[560px] md:min-h-screen py-16 sm:py-24 md:py-32 bg-white overflow-hidden flex flex-col justify-center items-center select-none border-b border-noir-950/[0.08]">
      <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-8 md:px-14 lg:px-16 flex flex-col items-center text-center">
        ...
        >
          <h2 className="font-editorial font-semibold text-3xl sm:text-5xl md:text-6xl lg:text-[4.5rem] xl:text-[5.1rem] text-noir-950 tracking-[-0.04em] leading-[1.04] uppercase text-center">
            WE HELP CREATE
            <br />
            MOMENTS OF BEAUTY
            <br />
        ...
        >
          <p className="font-jakarta text-noir-600 text-xs sm:text-base md:text-lg font-normal leading-relaxed text-center mb-6 sm:mb-8 max-w-lg sm:max-w-xl">
          ...
          <Link
            href="/about"
            className="group relative inline-flex flex-col items-center text-noir-950 font-jakarta text-sm sm:text-base md:text-xl font-semibold tracking-wide hover:text-noir-700 transition-colors duration-300"
          >
            <span>Read More</span>
            {/* Animated Underline */}
