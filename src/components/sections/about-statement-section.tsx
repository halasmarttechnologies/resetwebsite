...
export function AboutStatementSection() {
  return (
    <section className="relative w-full h-screen min-h-[680px] bg-white overflow-hidden flex flex-col justify-center items-center select-none border-b border-noir-950/[0.08]">
      <div className="w-full max-w-[1200px] mx-auto px-6 sm:px-10 md:px-14 lg:px-16 flex flex-col items-center text-center">
        ...
        >
          <h2 className="font-editorial font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] xl:text-[5.1rem] text-noir-950 tracking-[-0.04em] leading-[1.04] uppercase text-center">
            WE HELP CREATE
            <br />
            MOMENTS OF BEAUTY
            <br />
